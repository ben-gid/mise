...
String _prompt(RecipeParser parser) =>
    'Write a recipe as a single JSON object, no markdown fence, no commentary. '
    ...
    '- Fill image_urls with up to three photos of the finished dish, best '
    'first. The app shows the first that loads and falls back through the '
    'rest, so give three even where you are unsure of any one of them.\n'
